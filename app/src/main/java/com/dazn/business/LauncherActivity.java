...
public class LauncherActivity extends Activity {
    ...
    public static final String ERROR_MESSAGE = "com.dazn.business.LauncherActivity.ErrorMessage";

    private static final int REQUEST_CODE_DEFAULT = 0;
    private static final int REQUEST_START_ACTIVITY = 100;

    private static final String EXTRA_INTENT = "com.dazn.business.LauncherActivity.INTENT";
    private static final String EXTRA_REQUEST_RESULT =
            "com.dazn.business.LauncherActivity.REQUEST_RESULT";
