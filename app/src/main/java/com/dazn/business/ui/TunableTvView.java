...
import com.dazn.business.InputSessionManager;
import com.dazn.business.InputSessionManager.TvViewSession;
...
import com.dazn.business.common.compat.TvInputConstantCompat;
import com.dazn.business.common.compat.TvViewCompat.TvInputCallbackCompat;
...
import com.dazn.business.ui.api.TunableTvViewPlayingApi;
import com.dazn.business.util.NetworkUtils;
import com.dazn.business.util.TvInputManagerHelper;
import com.dazn.business.util.Utils;
import com.dazn.business.util.images.ImageLoader;
...
public class TunableTvView extends FrameLayout implements StreamInfo, TunableTvViewPlayingApi {
     ...
     * TvView}. If either {@code width} or {@code height} is non positive, the
     ...
     * SurfaceView} and its underlying window can be misaligned, when the size of
     * {@link SurfaceView} is changed without changing either left position or top
    ...
    /** Returns the {@link SurfaceView} of the {@link TvView}. */
    ...
    /**
     * Gets {@link MarginLayoutParams} of the underlying {@link TvView},
    ...
    /**
     * Sets {@link MarginLayoutParams} of the underlying {@link TvView},
     * which is the actual view to play live TV videos.
     */
