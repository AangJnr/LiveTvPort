...
import com.dazn.business.common.compat.api.RecordingClientCallbackCompatEvents;
...
public final class RecordingClientCompatProcessor
    ...
    private void handle(String inputId, RecordingEvents.NotifyDevRecordingToast devToast) {
