...
package com.dazn.business.dvr.data;
...
import com.dazn.business.dvr.provider.DvrContract.Schedules;
import com.dazn.business.util.CompositeComparator;
...
public final class ScheduledRecording implements Parcelable {
    ...
    public static final Creator<ScheduledRecording> CREATOR =
            new Creator<ScheduledRecording>() {
                @Override
            ...
            if (TextUtils.equals(mSeasonNumber, "0")) {
                ...
                return String.format(
                        context.getResources()
                                .getString(com.dazn.business.common.R.string.display_episode_title_format_no_season_number),
                        mEpisodeNumber,
                        episodeTitle);
            } else {
                return String.format(
                        context.getResources().getString(com.dazn.business.common.R.string.display_episode_title_format),
                        mSeasonNumber,
                        mEpisodeNumber,
                        episodeTitle);
            }
