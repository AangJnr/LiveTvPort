...
public class ChannelDataManager {
    ...
    public void start() {
        ...
        mContentResolver.registerContentObserver(
                Channels.CONTENT_URI, true, mChannelObserver);
    ...
    public void applyUpdatedValuesToDb() {
        ...
        String column = Channels.COLUMN_BROWSABLE;
        ...
        mDbExecutor.execute(
                () -> {
                    ...
                    mContentResolver.update(
                            Channels.CONTENT_URI, values, selection, null);
                });
    }
