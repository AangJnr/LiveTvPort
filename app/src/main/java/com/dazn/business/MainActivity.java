...
package com.dazn.business;

import static com.dazn.business.common.feature.SystemAppFeature.SYSTEM_APP_FEATURE;
...
import com.dazn.business.MainActivity.MySingletons;
import com.dazn.business.analytics.Tracker;
import com.dazn.business.audio.AudioManagerHelper;
import com.dazn.business.audiotvservice.AudioOnlyTvServiceUtil;
import com.dazn.business.common.BuildConfig;
import com.dazn.business.common.CommonConstants;
import com.dazn.business.common.CommonPreferences;
import com.dazn.business.common.SoftPreconditions;
import com.dazn.business.common.TvContentRatingCache;
import com.dazn.business.common.WeakHandler;
import com.dazn.business.common.compat.TvInputInfoCompat;
import com.dazn.business.common.dev.DeveloperPreferences;
import com.dazn.business.common.feature.CommonFeatures;
import com.dazn.business.common.memory.MemoryManageable;
import com.dazn.business.common.singletons.HasSingletons;
import com.dazn.business.common.ui.setup.OnActionClickListener;
import com.dazn.business.common.util.CommonUtils;
import com.dazn.business.common.util.ContentUriUtils;
import com.dazn.business.common.util.Debug;
import com.dazn.business.common.util.DurationTimer;
import com.dazn.business.common.util.PermissionUtils;
import com.dazn.business.common.util.SystemProperties;
import com.dazn.business.data.ChannelDataManager;
import com.dazn.business.data.ChannelImpl;
import com.dazn.business.data.OnCurrentProgramUpdatedListener;
import com.dazn.business.data.ProgramDataManager;
import com.dazn.business.data.ProgramImpl;
import com.dazn.business.data.StreamInfo;
import com.dazn.business.data.WatchedHistoryManager;
...
import com.dazn.business.dialog.HalfSizedDialogFragment;
import com.dazn.business.dialog.PinDialogFragment;
import com.dazn.business.dialog.PinDialogFragment.OnPinCheckedListener;
import com.dazn.business.dialog.SafeDismissDialogFragment;
import com.dazn.business.dvr.DvrManager;
import com.dazn.business.dvr.data.ScheduledRecording;
import com.dazn.business.dvr.recorder.ConflictChecker;
import com.dazn.business.dvr.ui.DvrAlreadyRecordedFragment;
import com.dazn.business.dvr.ui.DvrAlreadyScheduledFragment;
import com.dazn.business.dvr.ui.DvrScheduleFragment;
import com.dazn.business.dvr.ui.DvrStopRecordingFragment;
import com.dazn.business.dvr.ui.DvrUiHelper;
import com.dazn.business.features.TvFeatures;
import com.dazn.business.guide.ProgramItemView;
import com.dazn.business.menu.Menu;
import com.dazn.business.onboarding.OnboardingActivity;
import com.dazn.business.parental.ContentRatingsManager;
import com.dazn.business.parental.ParentalControlSettings;
import com.dazn.business.perf.StartupMeasureFactory;
import com.dazn.business.receiver.AudioCapabilitiesReceiver;
import com.dazn.business.recommendation.ChannelPreviewUpdater;
import com.dazn.business.recommendation.NotificationService;
import com.dazn.business.search.ProgramGuideSearchFragment;
import com.dazn.business.tunerinputcontroller.BuiltInTunerManager;
import com.dazn.business.ui.ChannelBannerView;
import com.dazn.business.ui.DetailsActivity;
import com.dazn.business.ui.InputBannerView;
import com.dazn.business.ui.KeypadChannelSwitchView;
import com.dazn.business.ui.SelectInputView;
import com.dazn.business.ui.SelectInputView.OnInputSelectedCallback;
import com.dazn.business.ui.TunableTvView;
import com.dazn.business.ui.TunableTvView.BlockScreenType;
import com.dazn.business.ui.TunableTvView.OnTuneListener;
import com.dazn.business.ui.TvOverlayManager;
import com.dazn.business.ui.TvOverlayManagerFactory;
import com.dazn.business.ui.TvViewUiManager;
import com.dazn.business.ui.sidepanel.ClosedCaptionFragment;
import com.dazn.business.ui.sidepanel.CustomizeChannelListFragment;
import com.dazn.business.ui.sidepanel.DeveloperOptionFragment;
import com.dazn.business.ui.sidepanel.DisplayModeFragment;
import com.dazn.business.ui.sidepanel.MultiAudioFragment;
import com.dazn.business.ui.sidepanel.SettingsFragment;
import com.dazn.business.ui.sidepanel.SideFragment;
import com.dazn.business.ui.sidepanel.parentalcontrols.ParentalControlsFragment;
import com.dazn.business.ui.sidepanel.parentalcontrols.RatingsFragment;
import com.dazn.business.util.AsyncDbTask;
import com.dazn.business.util.AsyncDbTask.DbExecutor;
import com.dazn.business.util.CaptionSettings;
import com.dazn.business.util.OnboardingUtils;
import com.dazn.business.util.SetupUtils;
import com.dazn.business.util.TvInputManagerHelper;
import com.dazn.business.util.TvSettings;
import com.dazn.business.util.TvTrackInfoUtils;
import com.dazn.business.util.Utils;
import com.dazn.business.util.ViewCache;
import com.dazn.business.util.account.AccountHelper;
import com.dazn.business.util.images.ImageCache;
...
import com.dazn.business.common.flags.BackendKnobsFlags;
import com.dazn.business.common.flags.LegacyFlags;
import com.dazn.business.common.flags.StartupFlags;
import com.dazn.business.common.flags.UiFlags;
...
// AOSP_Comment_Out     private static final String PLUTO_TV_PACKAGE_NAME = "tv.pluto.android";
    ...
    private static final String KEY_INIT_CHANNEL_ID = "com.dazn.business.init_channel_id";
