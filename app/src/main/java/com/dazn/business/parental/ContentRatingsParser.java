...
package com.dazn.business.parental;
...
import com.dazn.business.parental.ContentRatingSystem.Order;
...
public class ContentRatingsParser {
    ...
    public static final String DOMAIN_SYSTEM_RATINGS = "com.dazn.business";
    ...
    private List<ContentRatingSystem> parse(
        ...
        // the content rating systems defined in TV app should be com.dazn.business instead of
