...
package com.dazn.business.common.util;
...
public final class CommonUtils {
    ...
    static {
        BUNDLED_PACKAGE_SET.add("com.dazn.business");
// AOSP_Comment_Out         BUNDLED_PACKAGE_SET.add(CommonConstants.BASE_PACKAGE);
    ...
    public static synchronized boolean isRunningInTest() {
        if (sRunningInTest == null) {
            try {
                Class.forName("com.dazn.business.testing.utils.Utils");
                Log.i(
                        TAG,
                        "Assumed to be running in a test because"
                                + " com.dazn.business.testing.utils.Utils is found");
                sRunningInTest = true;
