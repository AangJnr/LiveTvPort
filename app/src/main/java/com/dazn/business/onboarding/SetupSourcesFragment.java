...
package com.dazn.business.onboarding;
...
public class SetupSourcesFragment extends SetupMultiPaneFragment {
    ...
    public static final String ACTION_CATEGORY = "com.dazn.business.onboarding.SetupSourcesFragment";
            ...
            public void onBindViewHolder(ViewHolder vh, GuidedAction action) {
                ...
                if (descriptionView != null) {
                    if (action.getId() == ACTION_HEADER) {
                        ...
                        descriptionView.setTextColor(
                                getResources()
                                        .getColor(com.dazn.business.common.R.color.common_setup_input_description, null));
